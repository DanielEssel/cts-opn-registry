...
import OPNIssuance from "@/components/operator/opn-issuance";
import { BadgeIcon, Mail, Phone, MapPin, Heart } from "lucide-react";
import Link from "next/link";

export default function OPNIssuancePage() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/operator/register" className="text-sm text-gray-600 hover:text-green-600 transition-colors">
                    Register Rider
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/operator/approvals" className="text-sm text-gray-600 hover:text-green-600 transition-colors">
                    Approvals
                  </Link>
                </li>
              </ul>
