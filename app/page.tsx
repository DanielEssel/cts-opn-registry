...
import {
  Shield, Search, CheckCircle, FileText, ArrowRight,
  MapPin, AlertCircle, Users, Lock, Zap, QrCode,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-9 h-9 bg-green-700 rounded-xl flex items-center justify-center shadow-sm">
              <Image src="/logo/rinlogo2.png" alt="RIN" width={22} height={22} className="object-contain brightness-200" />
            </div>
            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 leading-none">CTS Africa</p>
              <p className="text-sm font-black text-slate-900 leading-tight">RIN Registry</p>
            </div>
          </Link>

          <nav className="flex items-center gap-2">
            <Link href="/retrieve">
              <Button variant="ghost" className="hidden sm:flex gap-2 text-slate-600 hover:text-slate-900 font-semibold">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] tracking-tight mb-5">
                Rider<br />
                <span className="text-green-700">Identification</span><br />
                <span className="text-yellow-500">Number System</span>
              </h1>

              <p className="text-lg text-slate-500 mb-8 max-w-md leading-relaxed">
                Official digital platform for commercial transport rider identification in Ghana.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 mb-12">
                <Link href="/retrieve">
                  <Button size="lg" className="bg-green-700 hover:bg-green-800 text-white font-bold gap-2 px-7 shadow-lg shadow-green-200 h-12">
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <div key={label} className="bg-white rounded-2xl p-3 border border-slate-200 shadow-sm text-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group rounded-2xl overflow-hidden shadow-xl border-4 border-green-100 hover:border-green-300 transition-all">
                  <div className="relative h-52 bg-slate-100">
                    <Image src="/images/pragya.avif" alt="Pragya" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="bg-white px-4 py-3 border-t border-slate-100">
                    <p className="font-black text-slate-900 text-sm">Pragya</p>
                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Three-wheeler</p>
                  </div>
                </div>
                ...
                <div className="group rounded-2xl overflow-hidden shadow-xl border-4 border-yellow-100 hover:border-yellow-300 transition-all mt-8">
                  <div className="relative h-52 bg-slate-100">
                    <Image src="/images/okada.jpg" alt="Okada" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="bg-white px-4 py-3 border-t border-slate-100">
                    <p className="font-black text-slate-900 text-sm">Okada</p>
                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Motorbike</p>
                  </div>
                </div>
                ...
                <div className="group rounded-2xl overflow-hidden shadow-xl border-4 border-blue-100 hover:border-blue-300 transition-all col-span-2">
                  <div className="relative h-48 bg-slate-100">
                    <Image src="/images/aboboyaa.webp" alt="Aboboyaa" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="bg-white px-4 py-3 border-t border-slate-100">
                    <p className="font-black text-slate-900 text-sm">Aboboyaa</p>
                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Tricycle</p>
                  </div>
                </div>
              </div>
      ...
      <section style={{ background: "#0c1117" }} className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-14">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-green-500 mb-3">Why This System</p>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-14">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-green-700 mb-3">Registration Process</p>
            <h2 className="text-4xl font-black text-slate-900">
              How to get your RIN
            </h2>
            <p className="text-slate-500 mt-3">Registration is done through authorized operators only.</p>
          </div>

          <div className="space-y-4">
            {[
              { step: "01", icon: MapPin,      title: "Visit an Authorized Operator",   body: "Find a registered government operator in your district. List available at district offices."              },
              { step: "02", icon: FileText,    title: "Bring Required Documents",        body: "Ghana Card, Driver's License, Vehicle Registration, and a passport photo."                                },
              { step: "03", icon: Users,       title: "Operator Registers You",          body: "The operator inputs your information into the system on your behalf. Takes about 5 minutes."             },
              { step: "04", icon: CheckCircle, title: "Receive Your RIN Certificate",    body: "Get your Rider Identification Number instantly with a QR code. Keep it safe for checks."                 },
            ].map(({ step, icon: Icon, title, body }, i) => (
              <div key={step} className="flex gap-6 items-start bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="shrink-0 w-14 h-14 rounded-2xl bg-green-700 flex items-center justify-center shadow-md">
                  <span className="mono text-sm font-black text-white">{step}</span>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            ...
            <div>
              <h3 className="font-black text-slate-900 text-lg mb-4">Important Notice</h3>
      ...
      <section className="py-24 stripe" style={{ background: "#166534" }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="text-4xl font-black text-white mb-4 leading-tight">
            Find your Rider<br />Identification Number
          </h2>
          <p className="text-green-200 mb-10 text-lg">
            Retrieve your RIN and check your permit status online in seconds.
          </p>
          <Link href="/retrieve">
            <Button size="lg" className="bg-white hover:bg-slate-50 text-green-900 font-black gap-2 px-8 h-13 shadow-2xl text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-slate-500 leading-relaxed max-w-xs">
                Official Rider Registration System for Ghana. Ensuring safe, legal, and regulated commercial transport across Greater Accra.
              </p>
            </div>

            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-4">For Riders</p>
              <ul className="space-y-2.5">
                {[["Find My RIN", "/retrieve"], ["Check Status", "/retrieve"]].map(([label, href]) => (
                  <li key={label}>
                    <Link href={href} className="text-sm text-slate-400 hover:text-white transition flex items-center gap-2">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-4">For Operators</p>
              <ul className="space-y-2.5">
                {[["Operator Login", "/login"], ["Register Riders", "/login"]].map(([label, href]) => (
                  <li key={label}>
                    <Link href={href} className="text-sm text-slate-400 hover:text-white transition flex items-center gap-2">
                      <ArrowRight className="h-3.5 w-3.5" /> {label}
                    </Link>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              {["Privacy", "Terms", "Contact"].map((l) => (
                <Link key={l} href="#" className="text-xs text-slate-600 hover:text-white transition">{l}</Link>
              ))}
            </div>
          </div>
        </div>
