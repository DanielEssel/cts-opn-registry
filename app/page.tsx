  ...
  <div className="max-w-7xl mx-auto px-6 relative z-10">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
      ...
      <div>
        ...
        {/* Updated Buttons - Better typography and sizing */}
...
{/* ── TRAINING SECTION (UPDATED with Read More) ── */}
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      {[
        ...
        <div
          key={title}
          className={`rounded-2xl p-6 border-2 border-${color}-100 bg-gradient-to-br from-${color}-50/30 to-white shadow-lg hover:shadow-xl transition-all group cursor-pointer`}
        >
    ...
    {/* Training Highlights */}
    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-3xl p-8 mb-10 border border-green-100">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <h3 className="text-xl font-black text-slate-900 mb-4 flex items-center gap-2">
            <span className="text-2xl">📋</span> What You'll Receive
          </h3>
        ...
        <div>
          <h3 className="text-xl font-black text-slate-900 mb-4 flex items-center gap-2">
            <span className="text-2xl">⏱️</span> Training Duration
          </h3>
          <ul className="space-y-3">
            {[
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          <div key={step} className="text-center">
            <div className="w-12 h-12 rounded-full bg-green-700 text-white flex items-center justify-center text-xl font-black mx-auto mb-3 shadow-lg">
              {step}
            </div>
...
{/* ── WHY SECTION ── (Your original, preserved) */}
...
{/* ── NOTICE ── (Your original, preserved but updated fee communication) */}
...
{/* ── FOOTER ── (Your original, preserved) */}
